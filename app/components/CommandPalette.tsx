...
const STATIC_COMMANDS: Command[] = [
  ...
  { id: "nav-tags",     label: "Go to Tag Browser",     category: "NAVIGATE", action: "navigate", href: "/tags" },
  { id: "nav-discover", label: "Go to Discover",        category: "NAVIGATE", action: "navigate", href: "/discover" },
  ...
  { id: "nav-new-note", label: "Go to New Note",        category: "NAVIGATE", action: "navigate", href: "/notes/new" },
